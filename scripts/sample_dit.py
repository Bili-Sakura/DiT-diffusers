...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sample images using a Diffusers DiT pipeline.")
    parser.add_argument("--model", required=True, help="Path or Hub id of a converted DiT pipeline.")
...
def main() -> None:
    ...
    pipe = DiTPipeline.from_pretrained(args.model, torch_dtype=dtype).to(args.device)
    output = pipe(
